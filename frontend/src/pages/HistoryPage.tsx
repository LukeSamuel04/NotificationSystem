...
import { Archive, RotateCcw, Clock, User, Tag, ChevronDown, ChevronUp, Search, RefreshCw } from 'lucide-react';
            ...
            return (
              <div key={item.id} style={{
                ...
                <div style={{ fontSize: '13px', color: '#94a3b8', marginBottom: '12px', display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                  ...
                  {item.received_at && (
                    <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><Clock size={14} /> {new Date(item.received_at).toLocaleString()}</span>
                  )}
                </div>
